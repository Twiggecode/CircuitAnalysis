...
This format will also accept an input file of test.net and and output file of test.out. The '-f' flag represents that the output data will be calculated and displayed in
